(function ( $ ){
	...
	*/
	...
	var defaultKey		= '2FzHEDpMWVCTpWgTadbI5TidT0xOPNNrVRRaFW5SuRh79wjw', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1032716905], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Temperature and Humidity', // Replaces Xively logo in the header
		...
		dataColor		= '000', // CSS HEX value of color to represent data (omit leading #)
